...
public class HdhomerunUI implements HdhomerunSignalMeterUiInt, IndeterminateProgressBarInt, DeviceListInt, TunerStatusObserverInt,
      ChannelMapObserverInt, ChannelMapListChangedObserverInt, ChannelChangedObserverInt, ProgramObserverInt, ProgramListObserverInt
{
   ...
   public void stop()
   {
      ...
      mProgramSpinner.setAdapter( new ArrayAdapter< String >( mMainActivity, android.R.layout.simple_spinner_item, new String[0] ) );
      mChannelMapSpinner.setAdapter( new ArrayAdapter< String >( mMainActivity, android.R.layout.simple_spinner_item, new String[0] ) );
      mDeviceSpinner.setAdapter( new ArrayAdapter< String >( mMainActivity, android.R.layout.simple_spinner_item, new String[0] ) );
   }
   ...
   {
      ArrayAdapter< ChannelScanProgram > adapter = new ArrayAdapter< ChannelScanProgram >( mMainActivity, android.R.layout.simple_spinner_item,
            aPrograms.toList() );
   ...
   {
      ArrayAdapter< String > adapter = new ArrayAdapter< String >( mMainActivity, android.R.layout.simple_spinner_item, aChannelMapList );
      adapter.setDropDownViewResource( android.R.layout.simple_spinner_dropdown_item );
